...
- **Broker integration**: Alpaca API end to end, covering account linking, ACH funding, transfers, live quotes, and order placement
...
- How to design the **strategy lifecycle** as a product surface: backtest, compare metrics, promote to live, monitor, and not just ship a chart
