...
draft: false
title: "Deep Trading"
snippet: "Plateforme de trading algorithmique de bout en bout : backtestez sur données historiques, analysez Sharpe et courbes d'équité, déployez des bots live avec garde-fous de risque, plus une marketplace de stratégies. SvelteKit + intégration Alpaca."
image:
...
- **Intégration broker** : API Alpaca de bout en bout, avec liaison de compte, financement ACH, virements, cotations live et placement d'ordres
...
- Concevoir le **cycle de vie d'une stratégie** comme surface produit : backtest, comparer les métriques, promouvoir en live, monitorer, et pas seulement livrer un graphique
